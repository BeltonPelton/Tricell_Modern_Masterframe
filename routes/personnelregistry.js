...
{    
    ...
    async function sqlQuery()
    {
        ...
        htmlOutput += "<div class=\"infobox\"> <div class=\"wrapper\" style=\"max-width: 740px\">"
...
router.get('/:employeeid', function(request, response)
{
    ...
    async function sqlQuery()
    {
        ...
        let htmlOutput = "<div class=\"infobox\"> <div class=\"wrapper\" style=\"max-width: 740px\">"

         // Skapa HTML-textsträng för tabellen för utskrift av XML-data
        htmlOutput +="<link rel=\"stylesheet\" href=\"css/personnel_registry_employee.css\" \/>\n"+ 
